...
public class ParallelGateWayTest {
	...
	public void statProcessInstance(){
		ProcessInstance pi = processEngine.getRuntimeService().startProcessInstanceByKey("parallelGateWay")// 与正在执行的流程实例和执行对象相关的Service  
	...
	public void findMyPersonaltask(){
		...
		//TaskQuery tqA=tq.taskUnassigned()//张三指定个人任务查询，指定办理人,办理人为空的时候未派职务的
				//.taskUnnassigned();
		TaskQuery tqA=tq.taskAssignee("买家");//费用报销申请,部门经理李四
